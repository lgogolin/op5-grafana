	...
	"status" : {
                ...
                "cell" : function(args) {
                        ...
                        if (args.obj.custom_variable_names.indexOf('GRAPHITEPREFIX') > -1) {
                                ...
                                grafana_link.attr('data-popover','image:https://web01-mon-prd.bmit.local:3000/render/dashboard-solo/db/host-dashboard?panelId=1&from=' + timeStamp_back + '&to=' + timeStamp + 'var-Host=' + args.obj.name + '&theme=light&width=700&height=250');
			...
			if (args.obj.custom_variable_names.indexOf('GRAPHITEPREFIX') > -1) {
                                ...
                                if (grafana_available) {
                                        ...
                                        grafana_link.attr('data-popover',
                                                'image:https://web01-mon-prd.bmit.local:3000/render/dashboard-solo/db/host-dashboard?panelId=' + panelId + '&from=' + timeStamp_6h +'&to=' + timeStamp +'var-Host=' + args.obj.host.name + grafana_extra_attr + '&theme=light&width=700&height=300'
                                        );
                                };
                                cell.append(grafana_link);
